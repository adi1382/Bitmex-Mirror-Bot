...
func (a *PositionApiService) PositionIsolateMargin(symbol string, localVarOptionals *PositionIsolateMarginOpts) (Position, *http.Response, error) {
	var (
...
@return Position
*/
func (a *PositionApiService) PositionTransferIsolatedMargin(symbol string, amount int) (Position, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
...
@return Position
*/
func (a *PositionApiService) PositionUpdateLeverage(symbol string, leverage float64) (Position, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
