...
import (
	...
	"github.com/adi1382/Bitmex-Mirror-Bot/swagger/optional"
)
...
func (a *OrderApiService) OrderAmend(localVarOptionals *OrderAmendOpts) (Order, *http.Response, error) {
	var (
...
func (a *OrderApiService) OrderAmendBulk(localVarOptionals *OrderAmendBulkOpts) ([]Order, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Put")
		localVarPostBody    interface{}
		localVarFileName    string
...
func (a *OrderApiService) OrderCancel(localVarOptionals *OrderCancelOpts) ([]Order, *http.Response, error) {
	var (
...
func (a *OrderApiService) OrderCancelAll(localVarOptionals *OrderCancelAllOpts) ([]Order, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Delete")
		localVarPostBody    interface{}
		localVarFileName    string
...
@return interface{}
*/
func (a *OrderApiService) OrderCancelAllAfter(timeout float64) (interface{}, *http.Response, error) {
	var (
...
func (a *OrderApiService) OrderClosePosition(symbol string, localVarOptionals *OrderClosePositionOpts) (Order, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
...
func (a *OrderApiService) OrderGetOrders(localVarOptionals *OrderGetOrdersOpts) ([]Order, *http.Response, error) {
	var (
...
func (a *OrderApiService) OrderNew(localVarOptionals *OrderNewOpts) (Order, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
...
func (a *OrderApiService) OrderNewBulk(localVarOptionals *OrderNewBulkOpts) ([]Order, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
