...
func (c *APIClient) InitializeAuth(apiKey, apiSecret string) {
	c.auth = NewAPIKeyContext(apiKey, apiSecret)
}
...
// NewAPIClient creates a new API subClient. Requires a userAgent string describing your application.
