...
type Order struct {
	...
	Account               NullFloat64 `json:"account,omitempty"`
	...
	OrderQty              NullFloat64 `json:"orderQty,omitempty"`
	Price                 NullFloat64 `json:"price,omitempty"`
	DisplayQty            NullFloat64 `json:"displayQty,omitempty"`
	...
	LeavesQty             NullFloat64 `json:"leavesQty,omitempty"`
	SimpleCumQty          NullFloat64 `json:"simpleCumQty,omitempty"`
	CumQty                NullFloat64 `json:"cumQty,omitempty"`
